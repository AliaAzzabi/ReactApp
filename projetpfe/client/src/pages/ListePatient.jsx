...
const TABLE_HEAD = ["Nom et prénom", "Date d'adhésion", "Téléphone",""];
...
function ListePatient() {
                                ...
                                <div>
                                    ...
                                    <div className="flex flex-col gap-2 sm:flex-row mt-2">
                                        <Link to="/addPatient" className="btn bg-indigo-500 hover:bg-indigo-600 text-white flex items-center">
                                            ...
                                            <span className="hidden xs:block ml-2">Ajouter un Patients</span>
                                        </Link>
                                    </div>
                                </div>
  ...
  <div className="overflow-y-auto max-h-[800px]">
    <table className="mt-4 w-full min-w-max table-auto text-left">
      ...
      <tbody>
        {TABLE_ROWS.map(
          ({ img, name, email, date, telephone,  }, index) => {
    ...
    <div className="flex items-center">
        <Tooltip content="Modifier" className="text-white bg-indigo-500 rounded-md">
            <IconButton variant="text" className='text-indigo-700' onClick={() => openModal({ img, name, email, date, telephone })}>
            ...
            <IconButton variant="text" className='text-red-800'>
                <TrashIcon className="h-4 w-4" />
                    ...
                    <div className="  fixed inset-0 z-50 overflow-y-auto flex items-center justify-center">
                        <div className=" dark:bg-gray-900  absolute inset-0 bg-black opacity-50"></div>
                        <div className=" dark:bg-gray-800  z-50 bg-white p-6 rounded-lg max-w">
                        <div className=' dark:bg-gray-800  overflow-hidden'>
        <h1 className="mb-8   leading-7  dark:text-gray-50 text-gray-800  ">Entrer les informations :</h1>
    </div>
                            <form>
