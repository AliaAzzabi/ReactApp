                    ...
                    <tr  className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                      <td className="w-4 p-4">
                        <div className="flex items-center">
                          <input id={`checkbox-table-search`} type="checkbox" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"/>
                          <label htmlFor={`checkbox-table-search`} className="sr-only">checkbox</label>
                        </div>
                      </td>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <button className="px-1 py-1 bg-indigo-200 dark:text-white text-gray-500 rounded-md dark:bg-gray-500 hover:bg-indigo-100" >Status</button>
                      </td>
                    </tr>
