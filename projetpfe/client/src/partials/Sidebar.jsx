      ...
      >
        ...
        <div className="flex justify-between mb-10 pr-3 sm:px-2">
          ...
          <div className="flex items-center">
            ...
            <span className={`text-white font-bold ml-2 text-lg animate-text ${sidebarExpanded ? 'block' : 'hidden'}`}>ADMIN</span>
          </div>
        </div>
          ...
          {user && userRole === "admin" && (
            <div>
              ...
              <h3 className="text-xs uppercase text-slate-500 font-semibold mt-7 mb-7 pl-3">
                ...
                <span className="lg:hidden lg:sidebar-expanded:block 2xl:block">Gestion des personnels</span>
              </h3>
              <ul className="mt-3">
          ...
          <div>
            ...
            <ul className="mt-3">
              ...
              <li className={`px-3 py-2 mt-4 mb-4 rounded-sm mb-0.5 last:mb-0 ${pathname.includes('inbox') && 'bg-slate-900'}`}>
                ...
                >
                  <div className="flex items-center">
                    <FontAwesomeIcon icon={faUser} className={`shrink-0 h-6 w-6 ${pathname.includes('inbox') ? 'text-indigo-500' : 'text-slate-600'}`} />
              ...
              <li className={`px-3 py-2 mt-4 mb-4 rounded-sm mb-0.5 last:mb-0 ${pathname.includes('calendar') && 'bg-slate-900'}`}>
                ...
                >
                  <div className="flex items-center">
                    <FontAwesomeIcon icon={faChair} className={`shrink-0 h-6 w-6 ${pathname.includes('calendar') ? 'text-indigo-500' : 'text-slate-600'}`} />
                    <span className="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                      Salle d'attente
                    </span>
                  </div>
              ...
              <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes('calendar') && 'bg-slate-900'}`}>
                ...
                >
                  <div className="flex items-center">
                    <FontAwesomeIcon icon={faHistory} className={`shrink-0 h-6 w-6 ${pathname.includes('calendar') ? 'text-indigo-500' : 'text-slate-600'}`} />
                    <span className="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                      Historique
                    </span>
                  </div>
