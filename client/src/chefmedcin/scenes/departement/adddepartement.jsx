                            ...
                            <form action="#" id="form_sample_1" className="form-horizontal mx-auto" style={customFormStyles}>
                                <div className="form-body" >
                                    ...
                                    <div className="form-group row">
                                        ...
                                        <span className="required red-star"> * </span></label>
                                        <div className="col-sm-10">
                                            <input type="number" name="nombreEmployes"  className="form-control input-height"  />
                                        </div>
                                    </div>
                                    <div className="form-group row">
                                        <label className="col-sm-2 col-form-label">Localisation</label>
                                        <div className="col-sm-10">
                                            <input type="text" name="localisation"  className="form-control input-height"  />
                                        </div>
                                    </div>
                                    <div className="form-group row">
                                        ...
                                        <span className="required red-star"> * </span></label>
                                        <div className="col-sm-10">
                                            <input type="text" name="responsable" className="form-control input-height"  />
                                        </div>
                                    </div>
                                    <div className="form-group row">
                                        ...
                                        <span className="required red-star"> * </span></label>
                                        <div className="col-sm-10">
                                            <input type="text" name="dateCreation"  className="form-control input-height"  />
                                        </div>
                                    </div>
                                    <div className="form-group row">
