                        ...
                        <div className="col-md-12 col-sm-12">
                            <div className="card card-box">
                                <div className="card-head">
                                    <header>Modifier Assistant</header>
                                ...
                                <div className="card-body" id="bar-parent">
                                    <form action="#" id="form_sample_1" className="form-horizontal">
                                        <div className="form-body">
                                            ...
                                            <div className="form-group row">
                                                <label className="col-sm-2 col-form-label">Poste
                                                    <span className="required red-star"> * </span>
                                                </label>
                                                <div className="col-sm-10">
                                                    <input type="text" name="designation" data-required={1} placeholder="entrez votre poste" className="form-control input-height" /> </div>
                                            </div>
                                            <div className="form-group row">
