                        ...
                        <div className="card-body" id="bar-parent">
                            <form action="#" id="form_sample_1" className="form-horizontal mx-auto" style={customFormStyles}>
                                <div className="form-body" >
                                    ...
                                    <div className="form-group row">
                                        <label className="col-sm-2 col-form-label">Spécialisation
                                            <span className="required red-star"> * </span>
                                        </label>
                                        <div className="col-sm-10">
                                    ...
                                    <div className="form-group row">
                                        ...
                                        <div className="col-sm-10">
                                            <select className="form-control input-height" name="department">
                                                ...
                                                <option value="Category 1">Neurologie</option>
                                                <option value="Category 2">Orthopédie</option>
                                                <option value="Category 3">Gynécologie</option>
                                                <option value="Category 3">Microbiologie</option>
                                                <option value="Category 3">Radiothérapie</option>
                                                <option value="Category 3">Pharmacie</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div className="form-group row">
